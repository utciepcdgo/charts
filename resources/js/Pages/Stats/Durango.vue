    ...
    <AppLayout title="Durango">
        ...
        <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
            <div class="grid md:grid-cols-2 sm:grid-cols-1 lg:md:grid-cols-3 gap-4 mb-4">
                <div class="flex flex-col lg:flex-row w-full items-center border border-gray-200 px-3 py-2 rounded shadow-lg">
                    <circle-chart :series="[materialSupplied.series.progress]" :width="300" :key="2"></circle-chart>
                ...
                <div class="flex flex-col lg:flex-row w-full items-center border border-gray-200 px-3 py-2 rounded shadow-lg">
                    ...
                    <div class="shrink w-full md:ml-3 grid grid-cols-1 justify-center text-center lg:text-left">
                        <p class="font-bold text-gray-500">Paquetes recibidos</p>
